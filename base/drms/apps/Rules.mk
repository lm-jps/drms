...
MODEXE_$(d)	:= $(addprefix $(d)/, drms_query drms_log createtabstructure createns accessreplogs drms_addkeys drms_dropkeys createshadow dropshadow) $(MODEXE_JSON_$(d))
...
SUMS_BIN	:= $(SUMS_BIN) $(MODEXE_SUMS_$(d)) $(CEXE_SUMS_$(d))
