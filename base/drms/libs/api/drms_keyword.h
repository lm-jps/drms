...
enum DRMS_Keyword_ExtType_enum
{
   ...
   kDRMS_Keyword_ExtType_Integer,
   kDRMS_Keyword_ExtType_Float,
   kDRMS_Keyword_ExtType_String,
   kDRMS_Keyword_ExtType_Logical,
   kDRMS_Keyword_ExtType_End
};

typedef enum DRMS_Keyword_ExtType_enum DRMS_Keyword_ExtType_t;
