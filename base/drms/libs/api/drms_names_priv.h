/**
\file drms_names_priv.h
*/
#ifndef __DRMS_NAMES_PRIV_H
#define __DRMS_NAMES_PRIV_H
 ...
 *  + A recordquery is a where clause on a non-prime key. 
 *  + A recordlist is a set of filters (by 'index' or 'value') on prime keys. This includes 
 *    filters that select records by recnum. */
