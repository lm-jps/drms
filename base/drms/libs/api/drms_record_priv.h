...
HContainer_t *drms_retrieve_linked_recordset(DRMS_Env_t *env, const char *link, DRMS_Record_t *template_record, DRMS_Record_t *parent_template_record, HContainer_t *keywords, HContainer_t *link_hash_map, int initialize_links, int cache_full_record, int *status);
...
xxx
*/
int drms_populate_record(DRMS_Env_t *env, DRMS_Record_t *record, long long recnum, int openLinks);
...
xxx
*/
char *drms_field_list(DRMS_Record_t *rec, int openLinks, int *num_args);
