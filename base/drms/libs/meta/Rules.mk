...
BASELIBS_OBJ_$(d)	:= $(LIBTHREADUTIL_OBJ) $(LIBRICECOMP_OBJ) $(LIBMISC_OBJ) $(LIBDSTRUCT_OBJ) $(LIBTIMEIO_OBJ) $(LIBFITSRW_OBJ)
...
$(LIBDRMS_META):	$(LIBJSOC_MAIN_OBJ) $(LIBDRMS_OBJ) $(LIBDEFSSERV_OBJ) $(LIBDB_OBJ) $(LIBSUMSAPI_OBJ) $(LIBCMDPARAMS_OBJ) $(BASELIBS_OBJ_$(d))
			$(ARCHIVE)
			$(SLLIB)

$(LIBDRMS_META_SOCK):	$(LIBJSOC_MAIN_SOCK_OBJ) $(LIBDRMSCLIENT_OBJ) $(LIBDEFSCLNT_OBJ) $(LIBDBCLIENT_OBJ) $(LIBCMDPARAMS_OBJ) $(BASELIBS_OBJ_$(d))
			$(ARCHIVE)
			$(SLLIB)
