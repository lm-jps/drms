                ...
                try:
                    ...
                    while True:
                        ...
                        try:
                            ...
                            if not sus:
                                raise Exception('lock', 'unable to lock and get sus ' + ','.join([ str(asunum) for asunum in self.sunums ]))
                            for su in sus:
                                if su.status == 'D':                                
    ...
    def run(self):
        ...
        try:
            ...
            try:
                ...
                if not su:
                    raise Exception('lock', 'unable to lock and get su ' + str(self.sunum))
