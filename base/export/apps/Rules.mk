...
MODEXE_$(d)	:= $(addprefix $(d)/, jsoc_export_as_fits jsoc_export_as_is jsoc_export_SU_as_is jsoc_fetch jsoc_stats1 jsoc_export_clone drms_export_cgi)

MODEXE_ONLY_$(d)	:= $(addprefix $(d)/, jsoc_info jsoc_export_manage)
