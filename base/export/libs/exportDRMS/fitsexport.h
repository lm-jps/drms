...
int fitsexport_mapexport_tofile2(DRMS_Record_t *rec, DRMS_Segment_t *seg, const char *cparms, const char *clname, const char *mapfile, const char *fileout, char **actualfname, unsigned long long *expsize, export_callback_func_t callback); //ISS fly-tar
...
int fitsexport_getmappedintkeyname(const char *keyname, const char *class, Exputl_KeyMap_t *map, char *nameOut, int size);

int fitsexport_importkey(CFITSIO_KEYWORD *fitskey, HContainer_t *keys, int verbose);
int fitsexport_mapimportkey(CFITSIO_KEYWORD *fitskey, const char *clname, const char *mapfile, HContainer_t *keys, int verbose);
