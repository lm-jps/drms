...
try:
    ...
    # AAAARGH! If jsoc_info_x.py is processing an HTTP POST request, then cgi.FieldStorage() reads from STDIN to get the arguments. This
    ...
    # in the check_call() function. BTW, 'series' is a parameter for jsoc_info_x, but not for jsoc_info. It gets stripped off
    # from the list of arguments passed in, and the remaining parameters are passed onto jsoc_info. 'series' is a list of internal DRMS series
    ...
    cmdList = [MOD_BIN + '/jsoc_info', 'JSOC_DBHOST=' + drmsParams.get('SERVER'), 'DRMS_DBTIMEOUT=600000', 'DRMS_QUERY_MEM=2048']
