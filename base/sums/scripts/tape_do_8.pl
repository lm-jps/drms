...
$| = 1;
$abortfile = "/usr/local/logs/tapearc/TAPEARC_ABORT8";
$DB = "jsoc_sums";
...
while(1) {			#keep it running for now
  $label = &labeldate;
  $logfile = "/usr/local/logs/tapearc/tape_do_8_".$label;
  $cmd = "/home/production/cvs/JSOC/bin/linux_ia64/tapearc8 -v jsoc_sums";
  $sleeptime = 60;
  print "$cmd\n";
