#!/usr/bin/perl
#
#Takes a file of tapeids for the t50 and inserts them into the sum_tape
...
#$IDTBL = "/home/jim/cvs/jsoc/scripts/sum/tapeid_t50.list"; #for t50
...
$user = "jim";
$password = "jimshoom";
$hostdb = "dcs0";      #host where Postgres runs
